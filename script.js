...
function showClock2() {
  ...
  document.getElementById("main-visual-time").innerHTML = msg;
}
      ...
      Array.prototype.forEach.call(this.wrapper, function (wr) {
        ...
        var getElemDistanceToTop = function (elem) {
          ...
          getOffsetFromTop = function (distanceToTop) {
            var offset =
              distanceToTop - window.innerHeight + self.additionalOffset;
            return offset >= 0 ? offset : 0;
          },
          getPixelsPerSecond = function () {
            var pixelsPerSecond =
              (window.innerHeight + self.wrapper[0].clientHeight) /
              self.secondsPerScreen;
          ...
          scrollControl = function () {
            ...
            self.scrollPos +=
              (targetScrollPos - self.offsetFromTop - self.scrollPos) *
              self.acceleration;
        ...
        window.requestAnimFrame(function render() {
          ...
          if (
            Math.round(self.scrollPos + self.offsetFromTop) != targetScrollPos
          ) {
            scrollControl();
          }
        });
